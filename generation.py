...
parser.add_argument('--n_sentences', type=int, default=1,
                                        help='number of sentences to be generated from each prompt')
parser.add_argument('--output_file', type=str, default='./output.txt',
                                        help='path to file where to store the generated sentences')
parser.add_argument('--prompt_list', type=str,
                                        help='path to file where to prompts are stored')
...
with open(args.prompt_list, 'r') as pr:
    prompt_list = pr.read().splitlines()
...
for idx, prompt in enumerate(prompt_list):
    ...
    for _ in range(args.n_sentences):
        ...
        try:
            ...
            print(tokens_generated_so_far)
            #print()
            f.write(tokens_generated_so_far.split(' ', 1)[1] + '\n')
            print('---------------------------------------')
